...
<?php
	...
	$query="SELECT *  FROM tabla_empleado";
...
<ul>
   ...
   <li class='last'><a href='#'><span>CUENTA</span></a>
	...
	<div id="cuadro">
		...
		<div id="titulo">
		<center><h1>Registros de Empleados</h1></center>
		</div>
		<a href="frm_Empleado.php" class="add">Agregar Nuevo</a><div class="derecha" id="buscar"> Buscar <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter"></div>
  <br><br>
				...
				<tbody>
					<?php while($row=$resultado->fetch_assoc()){ ?>
						<tr>
							...
							<td class="centar">
								<a href="Ver_Empleado.php?id=<?php echo $row['cod_empleado'];?>" class="ver">Ver Detalles</a>
							</td>
							<td class="centar">
								<a href="Editar_Empleado.php?id=<?php echo $row['cod_empleado'];?>" class="editar">Editar</a>
							</td>
							<td class="centar">
								<a href="ejecucion_php/Eliminar_Empleado.php?id=<?php echo $row['cod_empleado'];?>" class="eliminar">Eliminar</a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
