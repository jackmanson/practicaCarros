   ...
   <li class='last'><a href='#'><span>CUENTA</span></a>
	...
	<div id="cuadro">
		...
		<center><h1>Lista de Usuarios</h1></center>
		 ...
		 <a href="frm_Usuario.php" class="add">Crear nuevo Usuario</a> <div class="derecha" id="buscar">Buscar <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter"></div>
  <br><br>
			...
			<thead>
				...
				<tbody>
					<?php while($row=$resultado->fetch_assoc()){ ?>
						<tr>
							<td><?php echo $row['no_usuario'];?>
							</td>
							<td>
								<?php 
								require('../connect_db.php');
								$vendedor =$row['empleado'];
							...
							<td class="centar">
								<a href="Editar_Usuario.php?id=<?php echo $row['no_usuario'];?>" class="editar">Editar</a>
							</td>
							<td class="centar">
								<a href="ejecucion_php/Eliminar_Usuario.php?id=<?php echo $row['no_usuario'];?>" class="eliminar">Eliminar</a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
