...
<ul>
   ...
   <li class='last'><a href='#'><span>CUENTA</span></a>
    ...
    <form action="ejecucion_php/Actualizar_Empleado.php" method="post">
		<table >
			<?php
              ...
              require('../connect_db.php');
                  ...
                  $sqlw = "select * from tabla_empleado where cod_empleado='$id'";
                      $result = mysql_query($sqlw);
                      while ($registro = mysql_fetch_array($result)){
             
                      echo "<table><tr class='polo' ><td colspan=2><center>DATOS DE EMPLEADO</center></td><tr>";
                      echo'<tr><td class="izquierd">CODIGO</td><td><input type="text" name="cod" class="form-field" value="'.$registro['cod_empleado'].'"></td></tr>';
                      ...
                      echo'<tr><td class="izquierd">CARGO</td><td><input type="text" name="cargo" class="form-field" value="'.$registro['cargo'].'"></td></tr>';
