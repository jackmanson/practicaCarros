...
$rs=mysql_query("UPDATE tabla_empleado SET cod_empleado='$code', nombre='$nombre', apellido='$apellido', cedula='$cedula',sede='$sede', Ciudad='$ciudad', celular='$tel', correo='$correo' WHERE cod_empleado ='$code'");
if(!$rs){
	$error = mysql_error();
...
{
   echo"<script language='javascript'> alert('Actualizado exitosamente !!'); location.href='../cuentaUsuario.php';</script>";
