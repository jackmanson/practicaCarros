...
<ul>
   ...
   <li class='last'><a href='#'><span>CUENTA</span></a>
	...
	<div id="cuadro">
		<center><img src="../image/tec.jpg" width="100%"><br>
		<div id="titulo">
		<center><h1>Lista de Usuarios</h1></center>
		</div>    
    <form action="ejecucion_php/Actualizar_Usuario.php" method="post">
		<table >
			<?php
              ...
              require('../connect_db.php');
                  ...
                  $sqlw = "select * from tabla_usuario where no_usuario='$id'";
                      $result = mysql_query($sqlw);
                      while ($registro = mysql_fetch_array($result)){
             
                      echo "<table><tr class='polo' ><td colspan=2><center>DATOS DEL USUARIO</center></td><tr>";
                      echo'<tr><td class="izquierd">NO. USUARIO</td><td><input type="text" name="cod" class="form-field" value="'.$registro['no_usuario'].'"></td></tr>';
                      echo'<tr><td class="izquierd">CODIGO EMPLEADO</td><td><input type="text" name="empleado" class="form-field" value="'.$registro['empleado'].'"></td></tr>';
                      echo'<tr><td class="izquierd">USUARIO</td><td><input type="text" name="user" class="form-field" value="'.$registro['usuario'].'"></td></tr>';
                      echo'<tr><td class="izquierd">CLAVE</td><td><input type="text" name="pass" class="form-field" value="'.$registro['clave'].'"></td></tr>';
                      echo'<tr><td class="izquierd">GRUPO </td><td><input type="text" name="grupo" class="form-field" value="'.$registro['tipo_usuario'].'"></td></tr></table>';
